...
public class Settings {
    public static final float CAMERA_START_PITCH = 15F;
    public static final float CAMERA_MIN_PITCH = CAMERA_START_PITCH - 15f;
    public static final float CAMERA_MAX_PITCH = CAMERA_START_PITCH + 15f;
